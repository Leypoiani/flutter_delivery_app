...
extension OrderStatusMatch on OrderStatus {
  ...
  T matchAny<T>(
      ...
      T Function()? initial,
      T Function()? loaded, required Function() loading, required Function() error, required Null Function() confirmRemoveProduct, required emptyBag, required Null Function() success}) {
    final v = this;
