...
import 'package:flutter_delivery_app/app/repositories/auth/order/order_repository.dart';
...
class OrderController extends Cubit<OrderState> {
  ...
  void incrementProduct(int index) {
    ...
    orders[index] =
        order.copyWith(amount: order.amount + 1); //sobrescrevendo a lista
    emit(
  ...
  void saveOrder(
    ...
    await _orderRepository.saveOrder(OrderDto(
        ...
        emit(
      state.copyWith(status: OrderStatus.sucess),
    );
  }
}
